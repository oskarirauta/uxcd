...
void load_config(const std::string& path) {
	...
	try {
		...
		if ( s.contains("cache_dir") && !s["cache_dir"].to_string().empty())
			settings.cache_dir = s["cache_dir"].to_string();
		...
		settings.console_enabled = flag("console_enabled", settings.console_enabled);
